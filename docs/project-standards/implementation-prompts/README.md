...
Future prompts should generalize and production-promote the accepted workspace hierarchy, strengthen teacher visibility, complete a beta-readiness sweep, and eventually remove legacy paths after stable production periods.
