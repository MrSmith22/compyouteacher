...
Future prompts should address Modules 2–3 evidence/argument repair, Module 1 transfer-oriented vocabulary, the consolidated Module 8–9 APA protocol, and eventual removal of the legacy Modules 4–7 path after a stable production period.
