...
Future prompts should strengthen shared workspace hierarchy and teacher visibility, complete a beta-readiness sweep, and eventually remove legacy paths after stable production periods.
