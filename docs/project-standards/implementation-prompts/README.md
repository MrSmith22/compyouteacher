...
Future prompts should improve the shared visual/success system, strengthen the dashboard and teacher visibility, and eventually remove legacy paths after stable production periods.
