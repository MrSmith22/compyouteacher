...
Future prompts should strengthen teacher visibility, run the Phase 7 beta-readiness sweep, and eventually remove legacy paths after stable production periods.
