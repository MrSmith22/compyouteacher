...
export const MODULE_ROLE_TRANSITIONS = Object.freeze([
  Object.freeze({
    ...
    actionLabel: "Start Body Paragraph 1",
  ...
  Object.freeze({
    ...
    toRole: "submission",
    accomplishment:
      "Your essay was submitted successfully—you carried one piece of writing all the way from analysis to a finished, submitted paper.",
    nextRole:
