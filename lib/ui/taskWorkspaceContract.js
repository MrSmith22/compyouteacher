...
export const TASK_WORKSPACE_COLOR_ROLES = Object.freeze({
  ...
  shelf: "reference",
  evidence: "evidence",
  /** Opt-in work override for Module 7 revision loci (WP-098). */
  revision: "revision",
});
 ...
 * @param {{ evidenceSurface?: boolean, revisionWorkSurface?: boolean }} [opts]
 */
export function describeTaskWorkspaceRegion(regionId, opts = {}) {
  ...
  if (opts.revisionWorkSurface && id === "work") {
    colorRoleId = "revision";
  }
