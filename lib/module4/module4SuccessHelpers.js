...
export const MODULE4_SUCCESS_ACCOMPLISHMENT =
  "You turned your Module 3 argument into paragraph plans with points, evidence, and reasoning.";
...
export const MODULE4_SUCCESS_MODULE5_HANDOFF =
  "Module 5 will arrange these paragraph plans into a full outline. Your saved points, evidence, and reasoning come with you—you are not starting over. Conclusion planning happens later in Module 5’s existing flow.";

export const MODULE4_SUCCESS_PRIMARY_CTA_LABEL =
