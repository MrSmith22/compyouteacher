...
export function buildModule4ParagraphPlanArtifact({
  ...
  return {
    ...
    readyHeading: `Paragraph ${paragraphNumber} plan is ready`,
    job: {
...
export function reasoningReadyNextActionLabel({
  ...
  if (paragraphIndex === 0) return "Plan Paragraph 2";
  if (paragraphIndex === 1) return "Decide whether you need Paragraph 3";
