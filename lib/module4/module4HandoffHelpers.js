...
export const HANDOFF_TRANSITION_SENTENCES = [
  ...
  "Module 4 turns that argument into paragraph plans—you are organizing thinking you started, not writing the essay yet.",
];
...
export const HANDOFF_STAGE1_ACCOMPLISHMENT =
  "In Module 3 you developed an idea, connected evidence, built a claim, and wrote a thesis. Module 4 turns that argument into paragraph plans.";
...
export function getHandoffTeacherGuidance({
  ...
  return {
    ...
    nextStep: "Start Paragraph 1 when you are ready to write the main idea.",
  };
}
