...
export function getSuccessTeacherGuidance({
  ...
  if (stage === SUCCESS_STAGE_EXPLORE) {
    ...
    return {
      coaching: `Paragraph ${n} carries the job “${job}.” Notice how its point, evidence, and reasoning work together.`,
      nextStep:
      ...
      planProgressLabel: `Paragraph ${n} of ${planArtifacts.length || 1}`,
    };
  }
