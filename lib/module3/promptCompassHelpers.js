...
/** IDEA also emphasizes the comparison question. */
export const IDEA_COMPASS_FOCUS_ID = "compare";

export const IDEA_COMPASS_FRAMING_LINE =
  "Right now, ask what the similarity, difference, or relationship you noticed might reveal about King’s rhetorical choices.";

/** CONNECT also emphasizes the comparison question. */
export const CONNECT_COMPASS_FOCUS_ID = "compare";

export const CONNECT_COMPASS_FRAMING_LINE =
...
/** EVALUATE emphasizes proving the idea with evidence from both works. */
export const EVALUATE_COMPASS_FOCUS_ID = "prove";

export const EVALUATE_COMPASS_FRAMING_LINE =
  "Right now, check whether your developing idea is supported by clear explanations and evidence from both the speech and the letter.";
