...
/**
 * Match a Module 4 paragraph plan to an outline body index.
 * Prefer explicit sourceParagraphIndex / paragraphIndex when any plan has one.
 * Otherwise use ordinal index (established Module 4→5 body order).
 * Never invent links across mismatched indices.
 */
export function matchParagraphPlan(paragraphPlans, bodyIndex) {
