...
const TRANSITION_6_TO_7 = getModuleRoleTransition(6, 7);
...
export const MODULE6_SUCCESS_PRIMARY_CTA = TRANSITION_6_TO_7.actionLabel;
export const MODULE6_SUCCESS_SECONDARY_REVIEW = "Review Module 6 draft";

export const MODULE6_SUCCESS_ACCOMPLISHMENT = TRANSITION_6_TO_7.accomplishment;

export const MODULE6_SUCCESS_HANDOFF = formatRoleTransitionHandoff(TRANSITION_6_TO_7);
...
export function getModule6SuccessStageMeta(stage) {
  ...
  return {
    eyebrow: "Module 6 · success",
    heading: "You've written a draft. Now let's strengthen it.",
