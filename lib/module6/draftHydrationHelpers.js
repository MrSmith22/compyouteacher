...
export function normalizeModule6DraftMeta(raw = null, fallback = {}) {
  ...
  return {
    ...
    // WP-081: preserve vertical-slice move state without rewriting prose.
    ...(src.verticalSlice && typeof src.verticalSlice === "object"
      ? { verticalSlice: src.verticalSlice }
      : fallback.verticalSlice && typeof fallback.verticalSlice === "object"
        ? { verticalSlice: fallback.verticalSlice }
        : {}),
  };
}
