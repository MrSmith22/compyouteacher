...
export function hydrateStep2Draft(raw, opts) {
  ...
  const ethosTransfer =
    raw.ethosTransfer && typeof raw.ethosTransfer === "object"
      ? raw.ethosTransfer
      : null;
  const vocabularyTransfer =
    raw.vocabularyTransfer && typeof raw.vocabularyTransfer === "object"
      ? raw.vocabularyTransfer
      : null;
