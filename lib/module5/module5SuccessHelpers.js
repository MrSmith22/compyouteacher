...
const TRANSITION_5_TO_6 = getModuleRoleTransition(5, 6);
...
export const MODULE5_SUCCESS_PRIMARY_CTA = TRANSITION_5_TO_6.actionLabel;
export const MODULE5_SUCCESS_SECONDARY_REVIEW = "Review Module 5 outline";

export const MODULE5_SUCCESS_ACCOMPLISHMENT = TRANSITION_5_TO_6.accomplishment;

export const MODULE5_SUCCESS_HANDOFF = formatRoleTransitionHandoff(TRANSITION_5_TO_6);
...
export function getModule5SuccessStageMeta(stage) {
  ...
  return {
    eyebrow: "Module 5 · success",
    heading: "Your outline is finished. Now you'll begin writing.",
