    ...
    <div className="max-w-5xl mx-auto p-6 sm:p-10 bg-theme-light rounded shadow space-y-8">
      <section className="text-center">
        ...
        <ol className="list-decimal list-inside space-y-1 text-theme-dark">
          ...
          <li>
            In a new tab, search for <code>"Letter from Birmingham Jail" full text</code> and find a trustworthy version of the letter on a .edu or .gov website.
          </li>
          <li>
            Paste the URL of the letter you found in the box provided so you can refer to it throughout the essay process.
          </li>
          <li>
            Record your observations and supporting quotes for <strong>ethos, pathos, logos, audience,</strong> and <strong>purpose</strong> in the T‑Chart below.
          </li>
        </ol>
      </section>
