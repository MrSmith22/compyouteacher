...
export default function ModuleSevenReadAloudObservation({
  ...
  return (
    <section
      className="rounded-xl border border-role-thinking/30 bg-role-thinking/[0.05] px-4 py-4 shadow-soft"
    ...
    >
      ...
      <h2 className="mt-1 text-base font-bold leading-snug text-text-primary md:text-lg">
        What did you notice?
      </h2>
            ...
            return (
              <label
                ...
                className={[
                  ...
                  checked
                    ? "border-role-thinking bg-white shadow-soft ring-1 ring-role-thinking/30"
