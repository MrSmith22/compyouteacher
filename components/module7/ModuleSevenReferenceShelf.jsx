...
export default function ModuleSevenReferenceShelf({
  assignmentQuestion = "",
  thesis = "",
  proofPlan = [],
  outline = null,
      ...
      >
        ...
        <div className="space-y-3 border-t border-border-soft/60 px-4 pb-4 pt-3">
          <p className="text-[11px] leading-relaxed text-text-muted/80">
            Full thesis, outline, draft map, plans, and evidence stay here for
            reference. Open this shelf only when you need a reminder beyond your
            desk.
          </p>
          ...
          <Card padding="sm" elevation="soft" surface="soft" className="space-y-3">
            ...
            >
              <div className="space-y-2">
                ...
                <OutlineSectionPreview
                  ...
                  isActive={
                    !highlightWholeDraft && activeStep?.type === "conclusion"
                  }
                  activeBadge={activeBadge}
                />
              </div>
              ...
              >
                {sectionSteps.map((step) => (
                  <DraftMapPreview
                    ...
                    activeBadge={
                      highlightWholeDraft ? "reading aloud" : activeBadge
                    }
                  />
                ))}
              </div>
            ...
            >
              {proofPlan.length > 0 ? (
                <ol className="list-inside list-decimal space-y-1 text-sm text-text-primary">
                  {proofPlan.map((line) => (
                    <li key={line}>{line}</li>
                  ))}
                </ol>
